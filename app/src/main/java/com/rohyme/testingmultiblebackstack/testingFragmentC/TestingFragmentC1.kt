...
import com.rohyme.testingmultiblebackstack.testingFragmentA.TestingFragmentA3Args

/**
 * Created by rohyme on 24/11/2021.
 **/
class TestingFragmentC1: Fragment(R.layout.test_fragment) {
    val navArgs by navArgs<TestingFragmentC1Args>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        testingTextView.setOnClickListener {
             findNavController().navigate(R.id.action_testingFragmentC1_to_testingFragmentC2)
        }
    }
}