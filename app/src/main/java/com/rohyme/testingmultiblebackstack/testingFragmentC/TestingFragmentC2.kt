 ...
 **/
class TestingFragmentC2: Fragment(R.layout.test_fragment) {
    val navArgs by navArgs<TestingFragmentC2Args>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        testingTextView.setOnClickListener {
             findNavController().navigate(R.id.action_testingFragmentC2_to_testingFragmentC3)
        }
    }
}