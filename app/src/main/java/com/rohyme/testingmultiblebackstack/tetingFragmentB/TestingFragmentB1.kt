...
import com.rohyme.testingmultiblebackstack.testingFragmentC.TestingFragmentC2Args

/**
 * Created by rohyme on 24/11/2021.
 **/
class TestingFragmentB1: Fragment(R.layout.test_fragment) {
    val navArgs by navArgs<TestingFragmentB1Args>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        testingTextView.setOnClickListener {
             findNavController().navigate(R.id.action_testingFragmentB1_to_testingFragmentB2)
        }
    }
}