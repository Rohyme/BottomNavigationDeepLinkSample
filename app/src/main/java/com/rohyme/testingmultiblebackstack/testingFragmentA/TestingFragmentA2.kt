 ...
 **/
class TestingFragmentA2: Fragment(R.layout.test_fragment) {
    val navArgs by navArgs<TestingFragmentA2Args>()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        testingTextView.setOnClickListener {
             findNavController().navigate(R.id.action_testingFragmentA2_to_testingFragmentA3)
        }
    }
}